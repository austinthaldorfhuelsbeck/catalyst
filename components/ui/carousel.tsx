...
function CarouselDots({
  ...
  return (
    <div className={cn('flex gap-2 justify-center absolute -bottom-12', className)} {...props}>
...
function CarouselCounter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  const { api } = useCarousel();
  const [selectedIndex, setSelectedIndex] = React.useState(0);
  const [slideCount, setSlideCount] = React.useState(0);
  ...
  return (
    <div
      className={cn('text-sm text-muted-foreground flex justify-center mt-4', className)}
      {...props}
    >
